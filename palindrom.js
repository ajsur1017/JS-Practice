...
function palindrome4(str) {
    ...
    return true; // Both parts are strictly equal, it returns true => The string is a palindrome4
    
   }
   
   console.log(palindrome4("A man, a plan, a canal. Panama"))
   console.log(palindrome4("A pretty random string"))
